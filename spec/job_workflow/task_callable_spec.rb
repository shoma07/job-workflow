...
RSpec.describe JobWorkflow::TaskCallable do
  ...
  describe "#called?" do
    ...
    context "when calling multiple times" do
      it "raises AlreadyCalledError on second call" do
        callable.call
        expect { callable.call }.to raise_error(JobWorkflow::TaskCallable::AlreadyCalledError)
      end
    end
  end

  describe JobWorkflow::TaskCallable::NotCalledError do
    describe "#initialize" do
  ...
  describe JobWorkflow::TaskCallable::AlreadyCalledError do
    describe "#initialize" do
