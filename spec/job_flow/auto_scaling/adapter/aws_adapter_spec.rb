...
RSpec.describe JobFlow::AutoScaling::Adapter::AwsAdapter do
  ...
  describe "#initialize" do
    ...
    context "when not defined Aws::ECS::Client" do
      it { expect { adapter }.to raise_error(JobFlow::Error, /aws-sdk-ecs is required/) }
    end
    ...
    context "when ECS_CONTAINER_METADATA_URI_V4 is missing" do
      ...
      it do
        expect { adapter }.to raise_error(JobFlow::Error, /ECS_CONTAINER_METADATA_URI_V4 is required/)
      end
    end
  ...
  describe "#update_desired_count" do
    ...
    context "when task does not exist" do
      ...
      it do
        expect { update_desired_count }.to raise_error(JobFlow::Error, /Task\(task-arn\) does not exist/)
      end
    end
    ...
    context "when service does not exist" do
      ...
      it do
        expect { update_desired_count }.to raise_error(JobFlow::Error, /Service\(my-service\) does not exist/)
      end
    end
  end
end
