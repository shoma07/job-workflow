...
RSpec.describe JobFlow::ContextSerializer do
  let(:context) do
    JobFlow::Context.new(arguments:, each_context: ctx_options)
  end
  let(:arguments) do
  ...
  describe "#klass" do
    ...
    it { is_expected.to eq(JobFlow::Context) }
  end
  ...
  describe "#serialize" do
    ...
    context "when context has task_outputs" do
      let(:context) do
        ctx = JobFlow::Context.new(arguments:)
